...
app.post('/api/teams', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Unable to create team', error: error.message });
    }
});
...
app.post('/api/activities', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Unable to create activity', error: error.message });
    }
});
...
app.post('/api/leaderboard', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Unable to create leaderboard entry', error: error.message });
    }
});
...
app.post('/api/workouts', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Unable to create workout', error: error.message });
    }
});
